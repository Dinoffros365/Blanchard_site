  ...
  document.querySelectorAll('.header__btn').forEach(function (tabsBtn) {
    tabsBtn.addEventListener('click', function (event) {
      ...
      if (name == name2) {
        ...
        document.querySelectorAll('.tab-content-active-top').forEach(function (tabContent) {
          tabContent.classList.remove('tab-content-active-top')
        })
        ...
        document.querySelector(`[data-target="${path}"]`).classList.add('tab-content-active-top')
